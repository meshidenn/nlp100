...
def get_sim_words(matrix,base,raw_word_file, cut = 10):
    rank = []
    sim_words = []
    for v in matrix:
...
def main(matrix_file, word_raw_file, raw_word_file):
    ...
    v1 = wordvec(matrix,word_raw,kw1)
    v2 = wordvec(matrix,word_raw,kw2)
    v3 = wordvec(matrix,word_raw,kw3)
    cand = v1 - v2 + v3
    sim_words = get_sim_words(matrix,cand,raw_word_file)
